...
PubSocket.prototype.publish = function (topic, chunk, encoding) {
    ...
    this.pubs.forEach(function (dest) {
        allpubs = allpubs && ch.publish(dest, topic, butter(chunk, encoding), options);
    });
    return allpubs;
};
...
PushSocket.prototype.write = function (chunk, encoding) {
    ...
    if (queue !== undefined) {
        ...
        return this.ch.sendToQueue(queue, butter(chunk, encoding), options);
    }
    else {
        return true;
    }
...
ReqSocket.prototype.write = function (chunk, encoding) {
    ...
    if (queue) {
        ...
        return ch.sendToQueue(queue, butter(chunk, encoding), options);
    }
    else {
        return true;
    }
...
RepSocket.prototype.write = function (chunk, encoding) {
    ...
    var res = ch.sendToQueue(replyTo, butter(chunk, encoding), options);
    ch.ack(current);
    return res;
};
...
TaskSocket.prototype.post = function (task, chunk, encoding) {
    ...
    return this.ch.sendToQueue(task, butter(chunk, encoding), options);
};
